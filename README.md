...
## ⚠️ Важное примечание по обходу DPI (z4r)
Скрипт обхода DPI \z4r\ (zapret) стабильно работает только в связке с **nftables**. При использовании \iptables\ наблюдаются проблемы с перехватом и маршрутизацией трафика.


## ⚠️ Настройка UDP в z4r
Убедитесь, что в настройках z4r **включен обход UDP на портах 1026-65531** (Опция 10 в меню z4r). Это критически важно для корректной работы некоторых сервисов и игр (BF6, Fifa и т.п.).
